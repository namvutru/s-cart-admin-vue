    ...
    <div class = "col-8">
      ...
      <b-form @submit="onSubmit" @reset="onReset" v-if="show">
        ...
        <b-form-group id="input-group-1" label="Category: " label-for="input-1">
          <b-form-select id="input-3" name="category_id" v-model="form.category_id" :options="listcategory"></b-form-select>
        </b-form-group>
        ...
        <b-form-group id="input-group-1" label="Code: " label-for="input-1">
          <b-form-input id="input-1" name="code" v-model="form.code" type="text"
  ...
  export default defineComponent({
    ...
    methods: {
      onSubmit(event) {
        ...
        formData.append('hot', this.form.hot);
